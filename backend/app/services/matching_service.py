...
class MatchingService:
    ...
    def rank_candidates_for_job(self, job_id: int) -> List[CandidateScore]:
        ...
        self.db.query(CandidateScore).filter(
    ...
    def _calculate_score(self, candidate: Candidate, job: Job) -> CandidateScore:
        ...
        explanation = self._generate_explanation(
            candidate, job, total_score, skills_score,
            experience_score, keywords_score, matched_skills, missing_skills
        )
    ...
    def _generate_explanation(
        self, candidate: Candidate, job: Job, total_score: float,
        skills_score: float, experience_score: float, keywords_score: float,
