...
class JiraSetup:
    ...
    def create_story(self, summary, description, epic_key, persona, priority="Medium", sprint_id=None):
        """Create a User Story"""
        url = f"{self.base_url}/rest/api/3/issue"
    ...
    def create_user_stories(self, epics, sprint1_id, sprint2_id):
        ...
        stories_data = [
            # Sprint 1 Stories
            {
                ...
                "sprint": sprint1_id,
                "subtasks": [
                    ("Frontend: Login UI", "Create login form with email/password fields", "Frontend"),
                    ("Backend: Auth endpoints", "Implement /auth/login and /auth/logout endpoints", "Backend"),
                    ("Testing: Auth tests", "Write unit and integration tests for authentication", "Testing")
                ]
            },
            {
                ...
                "sprint": sprint1_id,
                "subtasks": [
                    ("Frontend: File upload component", "Create drag-and-drop file upload UI", "Frontend"),
                    ("Backend: CV upload endpoint", "Implement /candidates/upload-cv endpoint with file handling", "Backend"),
                    ("Testing: Upload tests", "Test file upload with various formats and sizes", "Testing")
                ]
            },
            {
                ...
                "sprint": sprint1_id,
                "subtasks": [
                    ("Frontend: Display parsed data", "Show extracted CV information in structured format", "Frontend"),
                    ("Backend: CV parsing logic", "Implement NLP-based CV parsing algorithm", "Backend"),
                    ("Testing: Parser accuracy tests", "Validate parsing accuracy with sample CVs", "Testing")
                ]
            },
            {
                ...
                "sprint": sprint1_id,
                "subtasks": [
                    ("Frontend: Job creation form", "Build form for job title, description, and required skills", "Frontend"),
                    ("Backend: Job management API", "Implement CRUD endpoints for job positions", "Backend"),
            ...
            # Sprint 2 Stories
            {
                ...
                "sprint": sprint2_id,
                "subtasks": [
                    ("Frontend: Ranking display", "Create ranked list view with match scores", "Frontend"),
                    ("Backend: Matching algorithm", "Implement skill-based ranking algorithm", "Backend"),
                    ("Testing: Algorithm validation", "Test ranking accuracy with various scenarios", "Testing")
                ]
            },
            {
                ...
                "sprint": sprint2_id,
                "subtasks": [
                    ("Frontend: Skills chart component", "Create bar chart for skills frequency", "Frontend"),
                    ("Backend: Skills analytics endpoint", "Implement /reports/top-skills endpoint", "Backend"),
            ...
            },
            {
                ...
                "subtasks": [
                    ...
                    ("Backend: Pipeline analytics", "Implement /reports/pipeline-stats endpoint", "Backend"),
            ...
            },
            {
                ...
                "sprint": sprint2_id,
                "subtasks": [
                    ("Frontend: Audit log viewer", "Create searchable and filterable log table", "Frontend"),
                    ("Backend: Audit log retrieval", "Implement /audit/logs endpoint with pagination", "Backend"),
                    ("Testing: Audit logging tests", "Verify all actions are logged correctly", "Testing")
                ]
            },
            {
                ...
                "sprint": sprint2_id,
                "subtasks": [
                    ("Frontend: Dashboard layout", "Create responsive dashboard with widgets", "Frontend"),
                    ("Backend: Dashboard data API", "Aggregate data for dashboard display", "Backend"),
                    ("Testing: UI/UX tests", "Test dashboard responsiveness and usability", "Testing")
                ]
            },
            {
                ...
                "subtasks": [
                    ...
                    ("Backend: User management endpoints", "Implement admin-only user endpoints", "Backend"),
